...
// export default class ParkPopup extends Component {
//   static propTypes = {
//     isOpen: PropTypes.bool.isRequired,
//       // Park object that has title, genre, poster, days and times
...
//           marginRight: 10,
//         },
//         parkContainer: this.state.expanded ? {
//           flexDirection: 'column',  // arrange image and park info in a column
//           alignItems: 'center',     // and center them
//         } : {
//           flexDirection: 'row',     // arrange image and park info in a row
//         },
//         parkInfo: this.state.expanded ? {
//           flex: 0,
...
//       } = this.props;
//       // Pull out movie data
//       const { name, empty_places, poster, days, times } = park || {};
...
//               <View
//                 style={[styles.parkContainer, this.getStyles().parkContainer]}
...
//                 </View>
//                 {/* Name and empty_places */}
//                 <View style={[styles.parkInfo, this.getStyles().parkInfo]}>
